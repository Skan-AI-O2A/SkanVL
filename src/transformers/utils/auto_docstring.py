    ...
    if model_name_lowercase is None:
        ...
        try:
            ...
            if model_name_lowercase in HARDCODED_CONFIG_FOR_MODELS:
                ...
                print(
                    f"🚨 Config not found for {model_name_lowercase} Here we are. You can manually add it to HARDCODED_CONFIG_FOR_MODELS in utils/auto_docstring.py"
                )
