...
"""video processor class for Skan-VL."""
...
class SkanVLVideoProcessorInitKwargs(VideosKwargs):
...
@add_start_docstrings(
    "Constructs a fast Skan-VL image processor that dynamically resizes videos based on the original videos.",
...
class SkanVLVideoProcessor(BaseVideoProcessor):
    ...
    valid_kwargs = SkanVLVideoProcessorInitKwargs
    model_input_names = ["pixel_values_videos", "video_grid_thw"]

    def __init__(self, **kwargs: Unpack[SkanVLVideoProcessorInitKwargs]):
