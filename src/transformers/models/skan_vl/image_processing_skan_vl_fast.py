...
"""Fast Image processor class for Skan-VL."""
...
from .image_processing_skan_vl import smart_resize
...
class SkanVLFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    """
...
@auto_docstring
class SkanVLImageProcessorFast(BaseImageProcessorFast):
    do_resize = True
    ...
    min_pixels = None
    max_pixels = None
    valid_kwargs = SkanVLFastImageProcessorKwargs
    model_input_names = ["pixel_values", "image_grid_thw", "pixel_values_videos", "video_grid_thw"]

    def __init__(self, **kwargs: Unpack[SkanVLFastImageProcessorKwargs]):
    ...
    def preprocess(
        ...
        **kwargs: Unpack[SkanVLFastImageProcessorKwargs],
    ) -> BatchFeature:
    ...
    def _preprocess_image_like_inputs(
        ...
        **kwargs: Unpack[DefaultFastImageProcessorKwargs],
        ...
        if videos is not None:
            logger.warning(
                "`SkanVLImageProcessorFast` works only with image inputs and doesn't process videos anymore. "
                "This is a deprecated behavior and will be removed in v5.0. "
                "Your videos should be forwarded to `SkanVLVideoProcessor`. "
            )
...
__all__ = ["SkanVLImageProcessorFast"]
